...
public class Register extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter aa = ArrayAdapter.createFromResource(context, R.array.gender, R.layout.simple_spinner_dropdown_item_v1);
...
//        cities_spinner.setAdapter(adapter);
    ...
    public void registerAction(View view) {
        if (name.getText().toString().isEmpty()) {
            APICall.showSweetDialog(Register.this, R.string.ExuseMeAlert, R.string.EnterName);
        }
        else  if (email.getText().toString().isEmpty()) {
            APICall.showSweetDialog(Register.this, R.string.ExuseMeAlert, R.string.EnterEmail);
        }
        else if(gender.equals(""))
        {
            APICall.showSweetDialog(Register.this, R.string.ExuseMeAlert, R.string.EnterName);
        }
        else if (phone.getText().toString().isEmpty() || password.getText().toString().isEmpty()) {
