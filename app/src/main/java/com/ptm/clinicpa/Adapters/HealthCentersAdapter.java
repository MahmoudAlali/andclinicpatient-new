...
public class HealthCentersAdapter extends RecyclerView.Adapter<HealthCentersAdapter.ListHolder> {
     ...
     * @param items
     */
    public HealthCentersAdapter(Context context, String items[], String[] price, String[] rank, String[] cities, Location_Beauty[] location_beauties , boolean []fav){
        this.context=context;
        this.items=items;
        this.price=price;
        this.rank=rank;
    ...
    boolean grid ;
    public HealthCentersAdapter(Context context, String items[], String[] price, String[] rank, String[] cities, Location_Beauty[] location_beauties, boolean grid, boolean[] fav){
        this.context=context;
        this.items=items;
        this.price=price;
        this.rank=rank;
...
//        ServicesAdapter.Item item=new ServicesAdapter.Item(row);
      ...
      /*  (holder).doctorFavorite.setOnClickListener(new View.OnClickListener() {
        ...
        ( holder).healthCntr.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("logo_id",itemArrayList.get(position).getLogo_id());
                if((holder).centerFavorite.getTag().equals(R.drawable.favorite)) {
                ...
                intent.putExtra("features",itemArrayList.get(position).getFeaturesIds());
                context.startActivity(intent);
            }
        });
        ...
        for (int i=0;i<itemArrayList.get(position).getFeaturesIds().size();i++)
        {
            if(i<8)
            {
                APICall.getSalonLogoDltWhenEmpty(BeautyMainPage.context,itemArrayList.get(position).getFeaturesIds().get(i),(holder).features[i]);
            }
        }
    ...
    public class ListHolder extends RecyclerView.ViewHolder {
        ...
        CardView cardView;
        ImageView [] features=new ImageView[8];
        ...
        public ListHolder(View itemView) {
            ...
            features[0]=itemView.findViewById(R.id.feature1);
            features[1]=itemView.findViewById(R.id.feature2);
            features[2]=itemView.findViewById(R.id.feature3);
            features[3]=itemView.findViewById(R.id.feature4);
            features[4]=itemView.findViewById(R.id.feature5);
            features[5]=itemView.findViewById(R.id.feature6);
            features[6]=itemView.findViewById(R.id.feature7);
            features[7]=itemView.findViewById(R.id.feature8);
        }
    }
    @Override
