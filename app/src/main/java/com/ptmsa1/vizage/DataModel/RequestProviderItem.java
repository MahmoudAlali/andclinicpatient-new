...
public class RequestProviderItem {
    String sup_id,sup_name,logo_id,rating,bdb_booking_period,deposit_prcntg;

    public RequestProviderItem(String sup_id,String sup_name,String logo_id,String rating,String bdb_booking_period,String deposit_prcntg )
    {
        this.sup_id=sup_id;
