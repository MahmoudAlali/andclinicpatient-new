...
public class PayFortPayment {
    ...
    //Statics
    private final static String MERCHANT_IDENTIFIER = "0cff82e0";//"Cyc0HZ9xV6j";//;
    private final static String ACCESS_CODE = "WwRruMHlqWSdeiPPCcqI";//"zx0IPmPy5jp1vAz8Kpg7";//;
    private final static String SHA_TYPE = "SHA-256";
    private final static String SHA_REQUEST_PHRASE = "$2y$10$A4LYloJvF";
...
//            requestPurchase();
    ...
    private com.payfort.sdk.android.dependancies.models.FortRequest getPurchaseFortRequest() {
        com.payfort.sdk.android.dependancies.models.FortRequest fortRequest = new FortRequest();
        if (payFortData != null) {
