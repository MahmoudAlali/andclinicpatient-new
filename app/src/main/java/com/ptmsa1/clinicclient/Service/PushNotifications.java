package com.ptmsa1.clinicclient.Service;
...
public class PushNotifications {
   ...
   public static void sendnotification_provider(Context context,String title,String body ,String action1,String action2) {
    ...
    public static void sendnotification_client(Context context,String title,String body) {
