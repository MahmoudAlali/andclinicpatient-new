...
public class Constants {
    ...
    public static String[][] effectStoredStringArayEn = {
            {"Very short", "Short", "Medium", "Tall", "Very tall"},
            {"Very short", "Short", "Medium", "Tall", "Very tall"},
            {"Very straight", "Straight", "Medium", "Curly", "very curly"}, {"Very small volume", "small volum", "Medium", "large volume", "Very large volume"}, {"Very small thickness", "small thickness", "Medium", "Thick", "Very thick"}, {"Zero","One","Two","Three", "Four"}, {"Very Light", "Light", "Medium", "Dark", "Very Dark"}, {"Very dry", "dry", "medium", "Mix", "Medium ", "Very oily"}, {"Normal", "Semi sensitive","Medium", "sensitive", "Very sensitive"},
            {"Normal", "Semi sensitive","Medium", "sensitive", "Very sensitive"},
            {"Normal", "Semi sensitive","Medium", "sensitive", "Very sensitive"},
            {"Very small volume", "small volum", "Medium", "large volume", "Very large volume"},
            {"Very small thickness", "small thickness", "Medium", "Thick", "Very thick"},
            {"Normal", "Semi damaged", "Medium", "Damaged", "Very damaged"},
            {"Very small volume", "small volum", "Medium", "large volume", "Very large volume"},
            {"Very Light", "Light", "Medium", "Dark", "Very Dark"},
            {"Normal", "Semi sensitive","Medium", "sensitive", "Very sensitive"},
            {"Very small volume", "small volum", "Medium", "large volume", "Very large volume"},
            {"Very dry", "dry", "medium", "Mix", "Medium ", "Very oily"},
            {"Normal", "Semi sensitive","Medium", "sensitive", "Very sensitive"}};

    public static String[][] effectStoredStringArayAr = {
            {"قصير جدًا","قصير","متوسط","طويل","طويل جدً"},
            {"قصير جدًا","قصير","متوسط","طويل","طويل جدً"},
            {"مستقيم جدًا","مستقيم","متوسط","مجعد","مجعد جدًا"},
            {"خفيف جدًا","خفيف","متوسط","كثيف","كثيف جدً"},
            {"خفيف جدًا","خفيف","متوسط","سميك","سميك جدًا"},
            {"صفر","واحد","اثنان","ثلاثة","أربعة"},
            {"فاتح جداً","فاتح","متوسط","غامق","غامق جداً"},
            {"جافة جدًا","جافة","متوسط","مختلطة" , "متوسط","دهنية"},
            {"ليست حساسة","تميل للحساسية","متوسطة","حساسة","حساسة للغاية"},
            {"ليست حساسة","تميل للحساسية","متوسطة","حساسة","حساسة للغاية"},
            {"ليست حساسة" , "تميل للحساسية","متوسطة","حساسة","حساسة للغاية"},
            {"خفيف جدًا","خفيف","متوسط" , "كثيف","كثيف جدًا"},
            {"خفيف جدًا","خفيف","متوسط","سميك","سميك جدًا"},
            {"ليس به ضرر", "يميل للتضرر","متوسط","متضرر","متضرر جدا"},
            {"خفيف جدًا","خفيف","متوسط" , "كثيف","كثيف جدًا"},
            {"فاتح جداً","فاتح","متوسط","غامق","غامق جداً"},
            {"ليست حساسة" ,"تميل للحساسية","متوسطة","حساسة","حساسة للغاية"},
            {"خفيف جدًا","خفيف","متوسط" ,"كثيف","كثيف جدًا"},
            {"جافة جدًا","جافة","متوسط","مختلطة","متوسطة","دهنية"},
            {"ليست حساسة","تميل للحساسية","متوسطة","حساسة","حساسة للغاية"}};
}
