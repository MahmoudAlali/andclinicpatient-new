...
//        }
//
//        String pdfname = "invoice "+ DateFormat.getDateInstance().toString() +".pdf";
//        pdfFile = new File(docsFolder.getAbsolutePath(), pdfname);
//        OutputStream output = new FileOutputStream(pdfFile);
//        Document document = new Document(PageSize.A4);
//        PdfPTable table = new PdfPTable(new float[]{3, 3, 3, 3, 3});
...
//        Font f = new Font(Font.FontFamily.TIMES_ROMAN, 30.0f, Font.UNDERLINE, BaseColor.BLUE);
//        Font g = new Font(Font.FontFamily.TIMES_ROMAN, 20.0f, Font.NORMAL, BaseColor.BLUE);
//        document.add(new Paragraph("Beauty Invoice \n\n", f));
//
//
////        for (int i = 0; i < MyList1.size(); i++) {
////            document.add(new Paragraph(String.valueOf(MyList1.get(i))));
...
//            Intent pickIntent = new Intent(Intent.ACTION_PICK, android.provider.MediaStore..EXTERNAL_CONTENT_URI);
...
public void ss() throws FileNotFoundException, DocumentException {
        createPdfWrapper();
        createPdf();
        previewPdf();
}
