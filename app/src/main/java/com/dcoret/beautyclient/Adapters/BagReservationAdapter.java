...
public class BagReservationAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public BagReservationAdapter(Context context, ArrayList <DataService> services){
        this.context=context;
...
//        ((BagReservationAdapter.Item) holder).textView.setOnClickListener(new View.OnClickListener() {
//            @Override
