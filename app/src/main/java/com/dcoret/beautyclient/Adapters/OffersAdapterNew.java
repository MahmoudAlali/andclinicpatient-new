...
public class OffersAdapterNew extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    Context context;
    Boolean grid=false;
    String items[];
    ...
    public OffersAdapterNew(Context context, ArrayList<DataOffer> offers, boolean grid, String name){
        this.context=context;
        this.offers=offers;
        this.grid=grid;
        this.name=name;
...
//             row = inflater.inflate(R.layout.offer_layout_example, parent, false);
            ...
            OffersAdapterNew.Item item = new OffersAdapterNew.Item(row);
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder holder, final int position) {
        ...
        try {
            ((OffersAdapterNew.Item) holder).textView.setText(offers.get(position).getName());
            ...
            ((OffersAdapterNew.Item) holder).textView.setOnClickListener(new View.OnClickListener() {
                @Override
